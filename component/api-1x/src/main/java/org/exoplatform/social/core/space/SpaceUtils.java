...
public class SpaceUtils {
  ...
  public static String createGroup(String spaceName, String creator) throws SpaceException {
    ...
    try {
      ...
      shortName = StringUtils.cleanString(spaceName);
   ...
   * @throws org.exoplatform.social.core.space.SpaceException with code INTERNAL_SERVER_ERROR
   */
  public static boolean isSpaceNameExisted(String spaceName) throws SpaceException {
    PortalContainer portalContainer = PortalContainer.getInstance();
    SpaceService spaceService = (SpaceService) portalContainer.getComponentInstanceOfType(SpaceService.class);
    // Checks whether spaceName has existed yet
    if (spaceService.getSpaceByPrettyName(StringUtils.cleanString(spaceName)) != null) {
      return true;
    }
    return false;
  }
   ...
   * @throws org.exoplatform.social.core.space.SpaceException with code UNABLE_TO_ADD_CREATOR
   */
   ...
   * @throws org.exoplatform.social.core.space.SpaceException if user is removed.
   */
  ...
  public static String buildGroupId(String prettyName, String parentGroupId) {
    ...
    while (hasNext) {
      ++extendPattern;
      checkedGroupId = StringUtils.cleanString(mainPatternGroupId + SPACE_STR + extendPattern);
      ExoContainer container = ExoContainerContext.getCurrentContainer();
  ...
  public static String buildPrettyName(Space space) {
    ...
    while (hasNext) {
      ++extendPattern;
      checkedPrettyName = StringUtils.cleanString(mainPatternPrettyName + SPACE_STR + extendPattern);
      ExoContainer container = ExoContainerContext.getCurrentContainer();
      IdentityManager idm = (IdentityManager) container.getComponentInstanceOfType(IdentityManager.class);
