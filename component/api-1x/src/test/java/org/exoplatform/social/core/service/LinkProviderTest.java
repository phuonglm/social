...
public class LinkProviderTest extends AbstractAPI1xTest {
  ...
  public void testGetProfileLink() throws Exception {
    ...
    Assert.assertNotNull("rootFullName must not be null.", rootFullName);
    ...
    Assert.assertEquals(expected, actualLink);
  ...
  public void testEscapeJCRSpecialCharacters() throws Exception {
    Assert.assertEquals("The method escapeJCRSpecialCharacters not escape special characters as expected", "%5B%5D%3A", LinkProvider.escapeJCRSpecialCharacters("[]:"));
  }
