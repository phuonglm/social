 ...
 * @author hoat_le
 */
public class RelationshipPublisherTest extends AbstractAPI1xTest {
  ...
  public void setUp() throws Exception {
    ...
    Assert.assertNotNull("relationshipManager must not be null", relationshipManager);
    relationshipPublisher = (RelationshipPublisher) getContainer().getComponentInstanceOfType(RelationshipPublisher.class);
    Assert.assertNotNull("relationshipPublisher must not be null", relationshipPublisher);
  }
